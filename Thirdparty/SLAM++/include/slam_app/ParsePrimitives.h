 ...
 *	@brief 3D vertex parse primitive handler
 */
class CVertexCam3DQuatParsePrimitive {
public:
    /**
     *	@brief enumerates all tokens that identify this parsed primitive
     *
...
//		C3DJacobians::Quat_to_AxisAngle(quat, axis);
        ...
        CParserBase::TVertexCam3D_Quat vert(n_pose_id, c[0], c[1], c[2],
                quat.w(), quat.x(), quat.y(), quat.z(), p_vertex[7], p_vertex[8], p_vertex[9], p_vertex[10], p_vertex[11]);
        // process the measurement
 ...
 */
class CEdgeP2C3DQuatParsePrimitive {
public:
    /**
     *	@brief enumerates all tokens that identify this parsed primitive
     *
        ...
        const std::string &UNUSED(r_s_token), _TyParseLoop &r_parse_loop)
    {
        ...
        CParserBase::TEdgeP2C3D_Quat landmark(p_pose_idx[0], p_pose_idx[1],
            p_measurement[0], p_measurement[1], p_matrix);
        // process the measurement
...
typedef CConcatTypelist<MakeTypelist_Safe((CEdge2DParsePrimitive,
    ...
    CIgnoreParsePrimitive, CVertexXYZParsePrimitive, CVertexCam3DParsePrimitive,/*CVertexCam3DQuatParsePrimitive,*/
    CEdgeP2C3DParsePrimitive, /*CEdgeP2C3DQuatParsePrimitive,*/ CVertexSCam3DParsePrimitive, CVertexSpheronParsePrimitive, CEdgeSpheron_XYZ_ParsePrimitive,
