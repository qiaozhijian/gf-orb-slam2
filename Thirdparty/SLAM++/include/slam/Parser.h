...
public:
     ...
     */
    struct TVertexCam3D_Quat : public CParseEntity {
        int m_n_id; /**< @brief vertex id */
         ...
         *	@param[in] qw is x axis angle
         *	@param[in] qx is y axis angle
         *	@param[in] qy is z axis angle
         *	@param[in] qz is z axis angle
         ...
         *	@note The vertices are only used as ground truth. Those are mostly not processed.
         */
        inline TVertexCam3D_Quat(int n_node_id, double p_x, double p_y, double p_z,
            double qw, double qx, double qy, double qz, double fx, double fy,
            ...
            :m_n_id(n_node_id)
        {
            ...
            m_v_position << p_x, p_y, p_z, qw, qx, qy, qz, fx, fy, cx, cy, d;
        }
     ...
     */
    struct TEdgeP2C3D_Quat : public CParseEntity {
         ...
         *	@endcode
         */
        inline TEdgeP2C3D_Quat(size_t n_node_0, size_t n_node_1,
            double f_delta_x, double f_delta_y, const double *p_upper_matrix_2x2)
            :m_n_node_0(n_node_0), m_n_node_1(n_node_1)
        {
